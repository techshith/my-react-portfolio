...
const Contact = React.forwardRef((props, ref) => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_ynuddx6",  // Replace with your actual service ID
        "template_ysra5en", // Replace with your actual template ID
        form.current,
        "d7LhMp-Pr5oChv7fZ"  // Replace with your actual public key
      )
      .then(
        (result) => {
