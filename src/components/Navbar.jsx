  ...
  return (
    <nav className="mb-20 flex items-center justify-between py-6">
      <div className="flex flex-shrink-0 items-center">
        <h1 className="text-5xl font-bold"> Vik</h1>
      </div>
      <div className="m-8 flex items-center gap-4 text-2xl">
        {/* LinkedIn Icon with link */}
        <a href="https://www.linkedin.com/in/veekshith-kajeepeta/" target="_blank" rel="noopener noreferrer">
          <FaLinkedin className="cursor-pointer text-blue-400" />
        </a>

        {/* GitHub Icon with link */}
        {/* <a href="https://github.com/veekshith-kajeepeta" target="_blank" rel="noopener noreferrer">
